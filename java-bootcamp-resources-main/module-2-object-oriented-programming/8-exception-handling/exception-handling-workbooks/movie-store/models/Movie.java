...
public class Movie {
    ...
    public Movie(String name, String format, double rating) {
        if (name == null || name.isBlank()) {
            throw new IllegalArgumentException("name cannot be left blank/null");
        }

        if (format == null || format.isBlank()) {
            throw new IllegalArgumentException("format cannot be left blank/null");
        }

        if (!(format.equalsIgnoreCase("Blue-Ray") || format.equalsIgnoreCase("DVD"))) {
            throw new IllegalArgumentException("format must be 'DVD' or 'Blue-Ray' only");
        }
