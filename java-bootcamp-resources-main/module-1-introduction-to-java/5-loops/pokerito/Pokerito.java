...
public class Pokerito {
    public static void main(String[] args) {
        ...
        System.out.println("Let's play Pokerito.  Press enter when you're ready.");
        scan.nextLine();
        ...
        System.out.println("The dealer will draw a card every time you press enter.  Press enter to continue.");
